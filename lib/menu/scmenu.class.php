 ...
 * @license     GNU General Public License version 2 or later; see LICENSE.dis
 */
 ...
 * @since       1.5
 */
class SCAdminCssMenu extends JObject
{
	/**
	...
	{
		$this->_root = new SCMenuNode('ROOT');
	 ...
	 *
	 * @param   SCMenuNode  &$node       The node to process
	 * @param   boolean    $setCurrent  True to set as current working node
	 *
	 * @return  void
	 */
	public function addChild(SCMenuNode &$node, $setCurrent = false)
	{
	...
	{
		$this->addChild(new SCMenuNode(null, null, 'separator', false));
	}
 ...
 * @since       1.5
 */
class SCMenuNode extends JObject
{
	/**
	 * Node Title
	 *
	 ...
	 *
	 * @param   SCMenuNode  &$child  The child to be added
	 *
	 * @return  void
	 */
	public function addChild(SCMenuNode &$child)
	{
	 ...
	 *
	 * @param   SCMenuNode  &$parent  The SCMenuNode for parent to be set or null
	 *
	 * @return  void
	 */
	public function setParent(SCMenuNode &$parent = null)
	{
	 ...
	 *
	 * @return  mixed  SCMenuNode object with the parent or null for no parent
	 */
	public function &getParent()
	{
		return $this->_parent;
